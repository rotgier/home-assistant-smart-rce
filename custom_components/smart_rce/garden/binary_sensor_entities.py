"""Garden binary sensors — non-work drift + mowing should-start + mowing hold.
...
either side is unknown, and muted while the mowing hold is active — the hold
...
class LubaNonWorkDriftBinarySensor(BinarySensorEntity):
    ...
    Muted while the mowing hold is active: the hold intentionally pushes an
    ...
    def __init__(self, entry: SmartRceConfigEntry) -> None:
        ...
        self._gate = entry.runtime_data.garden.hold
