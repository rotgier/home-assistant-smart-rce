...
class TestHourlyBalanceGuard:
    ...
    def test_dod_zero_negative_balance_forces_both_off(self):
        ...
        assert mgr.water_heater.should_turn_off_small is True
        assert mgr.battery.should_block_battery_charge is True
    ...
    def test_dod_zero_release_after_threshold(self):
        ...
        assert mgr.battery.should_block_battery_charge is False
    ...
    def test_dod_greater_than_zero_guard_inactive(self):
        ...
        assert mgr.battery.should_block_battery_charge is False
        assert mgr.water_heater.should_turn_on is True  # ASAP: 5000 > 3300
